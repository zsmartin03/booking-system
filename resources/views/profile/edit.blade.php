                    ...
                    <div class="border-t border-frappe-surface1 pt-8">
                        ...
                        <form method="POST" action="{{ route('profile.update-password') }}">
                            ...
                            <div class="space-y-4">
                                <!-- Current Password -->
                                <div>
                                    <x-input-label for="current_password" :value="__('Current Password')" class="text-frappe-subtext1" />
                                    <x-text-input
                                        id="current_password"
                                ...
                                <!-- Confirm Password -->
                                <div>
                                    <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="text-frappe-subtext1" />
                                    <x-text-input
