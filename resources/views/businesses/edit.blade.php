                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('businesses.update', $business->id) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-sm text-frappe-subtext1 mt-1">{{ __('messages.address_or_click_map') }}</p>
                        </div>

                        <!-- map -->
                        <div class="mb-4">
                            <x-input-label :value="__('messages.location_map')" />
                            <div id="business-form-map"
                                class="w-full h-96 bg-frappe-surface0/30 rounded-lg mt-2 border border-frappe-surface2/50">
                            </div>
                            <p class="text-sm text-frappe-subtext1 mt-1">{{ __('messages.click_map_to_set_location') }}
                            </p>
                        </div>
