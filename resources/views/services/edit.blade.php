    ...
    <div class="py-6 max-w-md mx-auto">
        <form method="POST" action="{{ route('services.update', $service->id) }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name" name="name" type="text" class="block w-full mt-1" :value="old('name', $service->name)"
                    required />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="price" name="price" type="number" class="block w-full mt-1" :value="old('price', $service->price)"
                    required min="0" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="duration" name="duration" type="number" class="block w-full mt-1" :value="old('duration', $service->duration)"
                    required min="1" />
            ...
            <div class="mb-4">
                ...
                <select id="employees" name="employees[]" class="block w-full mt-1" multiple>
                    @foreach ($employees as $employee)
                        <option value="{{ $employee->id }}" @selected(in_array($employee->id, old('employees', $service->employees->pluck('id')->toArray())))>{{ $employee->name }}</option>
                    @endforeach
                </select>
