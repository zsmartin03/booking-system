        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <label for="business"
                                class="text-frappe-text font-medium">{{ __('messages.business') }}:</label>
                            <select id="business"
                        ...
                        <div class="flex items-center gap-2">
                            <label for="period"
                                class="text-frappe-text font-medium">{{ __('messages.period') }}:</label>
                            <select id="period"
                                ...
                                <option value="day" {{ $period === 'day' ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="frosted-card rounded-xl p-6 shadow-lg">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-frappe-subtext1 text-sm font-medium">{{ __('messages.total_customers') }}
                            </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="frosted-card rounded-xl p-6 shadow-lg">
                    <h3 class="text-xl font-semibold text-frappe-text mb-4">{{ __('messages.bookings_over_time') }}
                    </h3>
                    <div class="h-80">
