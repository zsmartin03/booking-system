<x-app-layout>
                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="description_hu" name="description_hu" rows="3"
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                    required>{{ old('description_hu') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 flex items-center gap-3">
                                <input id="color" name="color" type="color"
                                    ...
                                    value="{{ old('color', '#8B5CF6') }}" required />
                                <input type="text"
                                    class="flex-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                    value="{{ old('color', '#8B5CF6') }}" readonly id="color-text">
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="p-4 rounded-lg">
                                <span id="category-preview"
                                    ...
                                    <span id="preview-text">{{ old('name_en', __('messages.category_name')) }}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            <a href="{{ route('categories.index') }}"
                                class="inline-flex items-center gap-2 bg-gradient-to-r from-gray-500/20 to-gray-600/20 backdrop-blur-sm border border-gray-400/30 text-gray-300 px-4 py-2 rounded-lg hover:from-gray-500/30 hover:to-gray-600/30 transition-all">
                                {{ __('messages.cancel') }}
                            </a>
    ...
    <script>
        ...
        updatePreview('{{ old('color', '#8B5CF6') }}');
